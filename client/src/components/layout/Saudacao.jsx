...
function Saudacao(){
    ...
    useEffect(()=>{
        ...
        //Interrompe a função ao desmontar o elemnto
        return () =>{
    ...
    function atualizaSaudacao(){
        ...
        //Obtendo hora e inteiro exemplo 21:15 retorna 21
        const hora = agora.getHours();

        //Obtendo dia da semana em inteiro iniciando em domingo com 0 e sabado com 6
        const dia = agora.getDay();

        //Declarando variavel testo saudacao
        let textoSaudacao = '';
